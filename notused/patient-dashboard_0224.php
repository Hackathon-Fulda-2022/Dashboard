...
<?php
	...
	while($row = pg_fetch_row($result)){
		echo '<li class="list-group-item"><a href="patient-dashboard.php?id='.$row[2].'">'.$row[0].' '.$row[1].'</a></li>';
		}*/
		if(is_numeric($_GET["id"])){
			...
			while($row = pg_fetch_row($result)){
				...
				$dtime = DateTime::createFromFormat("d.m.Y", "31.09.1967");
			...
			echo($patient["pfName"]. " " .$patient["psName"]);
		} else{
						...
						<div class="col-md-4 col-xl-3">
							<div class="card mb-3">
								...
								<div class="card-body text-center">
									...
									<div class="text-muted mb-2"><?php echo($patient["birthdate"]); ?></div>
							...
							<div class="card">
								...
								<div class="card-body h-100">
									...
									<div class="d-flex align-items-start">
										<img src="img/avatars/avatar-5.jpg" width="0" height="0" class="rounded-circle me-2" alt="Vanessa Tucker">
									...
									<div class="d-flex align-items-start">
										...
										<div class="flex-grow-1">
											...
											<div class="border text-sm text-muted p-2 mt-1">
												...
												?>
												yyy:
												 rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus
												pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. NuEtiamllam quis ante.
											</div>
